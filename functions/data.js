...
const carrusels = [
    {
        enable: true,
        image: 'https://firebasestorage.googleapis.com/v0/b/web-hct.appspot.com/o/carrusel%2FgbeqE07702.jpg?alt=media&token=7b5bb186-8feb-4832-ae29-8e25e1ff6eb2'
    },
    {
        enable: true,
        image: 'https://firebasestorage.googleapis.com/v0/b/web-hct.appspot.com/o/carrusel%2Fshare-2022.jpg?alt=media&token=85682279-01d0-4654-99e5-b663c3a02872'
    },
    {
        enable: true,
        image: 'https://firebasestorage.googleapis.com/v0/b/web-hct.appspot.com/o/carrusel%2FHot-Sale-2022-fechas-descuentos.jpg?alt=media&token=af6bafa4-6015-4ca7-b78a-d5e495816861'
    }
]
...
const products = [
    {
        ...
        "image": "https://firebasestorage.googleapis.com/v0/b/web-hct.appspot.com/o/products%2Fw11.jpg?alt=media&token=36939509-0c5a-4846-867a-7f5e6ae69de2",
    ...
    },
    {
        ...
        "rating": 3.2,
        "features": "Intel Core i7-1165G7,12 MBH L3 cache, 4 core,8gb de Ram, 250Gb SSD",
        "image": "https://firebasestorage.googleapis.com/v0/b/web-hct.appspot.com/o/products%2FHp-spectre.jpg?alt=media&token=d68561f2-5f9b-4601-b6d8-5e6c80b0e734",
        "city": {
            "Tegucigalpa": 6,
            "San Pedro Sula": 4
        },
    ...
    },
    {
        ...
        "features": "Intel Core i7-7700HQ 2.8 GHz Hexa-Core, 8GB DDR4, 256GB SSD, retroiluminada",
        "image": "https://firebasestorage.googleapis.com/v0/b/web-hct.appspot.com/o/products%2FMSI.jpg?alt=media&token=a937198d-5f3c-4ba5-928f-6a76183474c9",
        "city": {
            "Tegucigalpa": 3,
            "San Pedro Sula": 9
        },
    ...
    },
    {
        ...
        "features": "Intel® Core™ i5-1145G7 de 11.ª generación (4 núcleos, caché de 8 M, base de 2,6 GHz hasta 4,4 GHz, vPro),Pantalla HD de 15,6\" (1366 x 768), sin función táctil, antirreflejo, TN, 220 nits, WLAN/WWAN, cámara HD",
        ...
        "available": true,
        "image": "https://firebasestorage.googleapis.com/v0/b/web-hct.appspot.com/o/products%2Ffondo%20products.jpg?alt=media&token=664ca056-9cee-4701-828f-4c0218dac86d",
    ...
    },
    {
        ...
        "image": "https://firebasestorage.googleapis.com/v0/b/web-hct.appspot.com/o/products%2FAcer.jpg?alt=media&token=ffa34ed0-6be7-4290-97ea-5ce670539870",
    ...
    },
    {
        ...
        "image": "https://firebasestorage.googleapis.com/v0/b/web-hct.appspot.com/o/products%2Flenovo.jpg?alt=media&token=234fbca1-5268-4277-9d2b-1e2a02b84441",
...
const rating = [
    ...
    },
    {
        ...
        email: 'jsantos@yourappland.com',
        vote: 3.5,
        commet: 'ultimamente el sistema va bien ya se han solucionado varios errores, es casi igual de bueno que windows 10 tiene potencial',
    },
    {
        id_produdct: 'NGjzSTHYnZwOFS7MwQhl',
    ...
    },
    {
        ...
        email: 'javier.ss896@gmail.com',
        vote: 2.5,
        commet: 'este pese me gusta mucho ya que el rendimiento es muy bueno, pero creo  que su precio es muy elevado para sus caracteristicas',
    },
    {
        id_produdct: 'pr6awLaP2TReLsMljGKb',
    ...
    },
    {
        ...
        email: 'javier.ss896@gmail.com',
        vote: 5,
        commet: 'una computadora muy bnonita, y liviana perfecta para llevar a cualquier parte',
    }
]
...
const affiliates = [
    ...
    },
    {
        ...
        phone: '50499999999',
        city: 'San Pedro Sula',
        address: 'colonia Satelite, calle principal una cuadra abajo las canchas de futbol por comedor Doña Tila',
        uid: 'uEsBg1dhrzTCdOtZMPcoU6OuhzI2',
    },
    {
        indentification_card: '',
        ...
        phone: '50495060180',
        city: 'Tegucigalpa',
        address: 'colonia San Miguel, calle principal una cuadra abajo las canchas de futbol',
        uid: 'A0TUSLqm41grSQTuH9xwgF1zeKl2',
    },
    {
    ...
    },
    {
        ...
        phone: '50495060180',
        city: 'Tegucigalpa',
        address: 'colonia Kennedy calle principal, una cuadra abajo la posta de policia, calle la flecha',
        uid: 'MxaPCTg1Q6am2D3bAzPydpEaH0e2',
    },
    {
    ...
    },
    {
        ...
        phone: '50495060180',
        city: 'San Pedro Sula',
        address: 'Tegucigalpa, colonia San Miguel, calle principal una cuadra abajo las canchas de futbol;',
        uid: 'U2m0V7Q1HZdWsI2FPUftveRfCSW2',
    },
    {
        indentification_card: '',
